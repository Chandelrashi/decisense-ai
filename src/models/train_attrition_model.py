...
TARGET_COL = "high_attrition_risk"
...
def main():
    ...
    # Save model
    out_model = MODELS_DIR / "attrition_model.joblib"
    dump(
        {
            "pipeline": pipe,
            "cat_cols": cat_cols,
    ...
    with open(ASSETS_DIR / "attrition_metrics.json", "w") as f:
        json.dump(metrics, f, indent=2)

    print("Saved:", out_model)
    print(
        f"AttritionModel: CV ROC-AUC {metrics['cv_roc_auc_mean']:.3f}±{metrics['cv_roc_auc_std']:.3f}, "
